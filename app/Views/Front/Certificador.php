...
<?= $this->section('content') ?>
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    <h3>Certificacion de Pedidos</h3>
  </nav>
  <!-- /.Inicia menu -->
                  ...
                  <div class="col-sm-3">
                      <div class="card card-green ">
                        ...
                        <div class="card-body" >
                          ...
                          <div class="row sm-1">
                            <div class="column" style="font-size:25px;" >Estado : </div>  
                            <div class="column" style="font-size:25px;" >Certificado</div>  
                          </div>
                        </table>
                        <a class="btn btn-sm" style="font-size:30px; color:black;" title="Asignar pedidos">
                          <i class="fas fa-clipboard-check"></i> Certificar
                        </a>       
                        </div>                        
                      </div>                      
  ...
  <div class="modal-dialog">
      ...
      <div class="modal-content">
          <div class="modal-header" style="background-color: red; color: white; font-style: inherit; font-size: xx-large;">
              <h2 class="modal-title">  Certificacion de pedidos </h2>
                  ...
                  <table class="table table-striped w-auto " id="table_export" style="font-size:25px; text-center">
                    ...
                    <tbody>
                      <tr id="casa1">
                        ...
                        <td style="">1.00</td>
                        <td style="">
                          <input type="checkbox" id="checkbox-2" class="custom-control custom-checkbox checkbox-xl" style="width: 30%; align:center" checked="">
                        </td>
                      </tr>
                      <tr id="casa1">
                        <td style="display:none">1112</td>
